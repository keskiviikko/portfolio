  ...
  render() {
    return (
      <div>
        <Container>
          <Row>
            <Col xs={2} className="imgContainer">
              <img
              ...
              <OverlayTrigger
                key="github"
                placement="left"
                overlay={<Tooltip className={"tooltip-github"}>GitHub</Tooltip>}
              >
                <a
              ...
              <OverlayTrigger
                key="linkedin"
                placement="right"
                overlay={<Tooltip className={"tooltip-linkedin"}>LinkedIn</Tooltip>}
              >
                <a
                  ...
                  <Accordion.Collapse eventKey="0">
                    <Card.Body>
                      ...
                      <p>
                        ...
                        ability to learn quickly and intuitively. I'm a diligent
                        employee and a reliable colleague. My goal is to get my
                        career started in IT industry as a junior developer. I'm
                        motivated by the industry’s immense possibilities and
                        challenges. I'm also skilled at composing written
                        material and I have great presentation skills.
                      </p>
                    </Card.Body>
                  </Accordion.Collapse>
                </Card>
                  ...
                  <Accordion.Collapse eventKey="1">
                    <Card.Body>
                      ...
                      <p>
                        ...
                        and came up with practical solutions to urgent problems.
                        I also learned valuable curriculum development skills
                        and organized courses and classes for hundreds of asylum
                        seekers. My lessons provided much needed purpose and
                        motivation for them.
                      </p>
                      <br />
                      <p>
                  ...
                  <Accordion.Collapse eventKey="2">
                    <Card.Body>
                      ...
                      <p>
                        ...
                        career for ambitious and driven individuals with the
                        right skills to acquire new knowledge. The education
                        method focuses on high-speed practical learning, agile
                        teamwork and continuous feedback dialogue. The education
                        is always based on specific tasks relevant to the
                        professional role. This makes the learning process
                        extremely efficient and consultants can contribute as
                        junior IT consultants from the first day after the
                        training.
                      </p>
                      <br />
                      <h3 className="animatedTitle">
                      ...
                      <p>
                        ...
                        Bachelor’s Thesis, which I wrote in English, concerning
                        the Disability Rights Movement in postwar Japan. The
                        three-year programme consisted of Japanese Language
                        courses (including grammar, kanji and spoken Japanese
                        classes) and various courses regarding Japan’s history,
                        society and culture.
                      </p>
                      <br />
                      <h3 className="animatedTitle">
